...
export const getGenres = createAsyncThunk("regalflix/genres", async () => {
  const {
    data: { genres },
  } = await axios.get(
...
const regalflixSlice = createSlice({
  name: "regalflix",
  initialState,
...
export const store = configureStore({
  reducer: {
    regalflix: regalflixSlice.reducer,
  },
});

export const { setGenres, setMovies } = regalflixSlice.actions;